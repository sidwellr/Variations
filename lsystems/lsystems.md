...
| presetId | -1: Use the grammar from the grammar parameter<br>Other: Use a preset grammar (currently 0 through 25, [visual index](lsystem-presets.pdf)) |
...
| --- | --- |
| grammar | The grammar for the L-System; see description above |
| presetId | 0: Use the grammar from the grammar parameter<br>Other: Use a preset grammar (currently 1 through 21, [visual index](lsystem3D-presets.pdf)) |
